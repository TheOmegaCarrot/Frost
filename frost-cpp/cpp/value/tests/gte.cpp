...
TEST_CASE("String Lexicographical GTE")
{
...
TEST_CASE("Array Lexicographical GTE")
{
    SECTION("Equal arrays")
    {
        ...
        CHECK(Value::internal_greater_than_or_equal(a, b));
    }
    ...
    SECTION("Strictly greater")
    {
        ...
        auto b = Value::create(frst::Array{Value::create(1_f), Value::create(2_f)});
        CHECK(Value::internal_greater_than_or_equal(a, b));
        CHECK_FALSE(Value::internal_greater_than_or_equal(b, a));
    }

    SECTION("Longer array is greater than or equal to its prefix")
    {
    ...
    SECTION("Incompatible element types throw")
    {
        ...
        CHECK_THROWS(Value::internal_greater_than_or_equal(a, b));
    }
}

TEST_CASE("Greater Than Or Equal Compare All Permutations")
{
...
#define OP_METHOD greater_than_or_equal
